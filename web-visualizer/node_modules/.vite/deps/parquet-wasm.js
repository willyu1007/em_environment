...
var WriterVersion = Object.freeze({ V1: 0, "0": "V1", V2: 1, "1": "V2" });
...
var FFIArrowArrayFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_ffiarrowarray_free(ptr >>> 0));
var FFIArrowArray = class {
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
...
var FFIArrowSchemaFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_ffiarrowschema_free(ptr >>> 0));
var FFIArrowSchema = class _FFIArrowSchema {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_FFIArrowSchema.prototype);
    obj.__wbg_ptr = ptr;
...
var FFIRecordBatchFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_ffirecordbatch_free(ptr >>> 0));
var FFIRecordBatch = class _FFIRecordBatch {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_FFIRecordBatch.prototype);
    obj.__wbg_ptr = ptr;
...
var FFITableFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_ffitable_free(ptr >>> 0));
var FFITable = class _FFITable {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_FFITable.prototype);
    obj.__wbg_ptr = ptr;
...
var FFIVectorFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
...
var WasmGetOptionsFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_wasmgetoptions_free(ptr >>> 0));
var WasmGetOptions = class {
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
...
var WasmObjectMetaFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_wasmobjectmeta_free(ptr >>> 0));
var WasmObjectMeta = class _WasmObjectMeta {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_WasmObjectMeta.prototype);
    obj.__wbg_ptr = ptr;
...
var WasmObjectStoreFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_wasmobjectstore_free(ptr >>> 0));
var WasmObjectStore = class {
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
  ...
  */
  setKeyValueMetadata(value) {
    try {
      ...
      return _WriterPropertiesBuilder.__wrap(r0);
    } finally {
      wasm.__wbindgen_add_to_stack_pointer(16);
    }
  }
  ...
  imports.wbg.__wbg_new_81740750da40724f = function(arg0, arg1) {
    try {
      ...
      var cb0 = (arg02, arg12) => {
        ...
        state0.a = 0;
        try {
          return __wbg_adapter_285(a, state0.b, arg02, arg12);
        } finally {
          state0.a = a;
        }
      };
