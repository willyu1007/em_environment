...
export interface InitOutput {
  ...
  readonly __wbg_parquetfile_free: (a: number) => void;
  ...
  readonly __wbg_parquetmetadata_free: (a: number) => void;
  ...
  readonly __wbg_wasmgetoptions_free: (a: number) => void;
  readonly __wbg_wasmobjectmeta_free: (a: number) => void;
  ...
  readonly __wbg_wasmobjectstore_free: (a: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1de40baa0df51db0: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h26b6dc7d05b06fdf: (a: number, b: number, c: number, d: number) => void;
}
